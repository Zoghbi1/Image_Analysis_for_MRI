...
i=imread('test/meningioma/(5).jpg');
i=rgb2gray(i);
%-------------------------------------
%2.Preprocessing
...
MM=[Contrast,Correlation,Energy,Homogeneity,area,Entropy,Mean,Skewness,Kurtosis];
[BrainTumorTissue]=predict(SVM_classifier,MM);